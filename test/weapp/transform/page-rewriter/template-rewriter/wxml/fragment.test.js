...
const parse = require(__dirname.replace('test', 'lib') + '/fragment').default
...
describe('template.include', () => {
  ...
  it('parse `include`', () => {
    ...
    const ret = parse(entryCode, pagePath, {}, fs)
    expect(ret.views.length).eql(2)
    expect(ret.templates.length).eql(2)
  })
